  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1600px] flex-col items-center gap-4 px-4 sm:px-6 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-4 sm:flex-row sm:justify-between sm:gap-8">
        <div className="pointer-events-auto rounded-2xl border border-champagne-gold/25 bg-midnight-navy/95 px-4 sm:px-6 py-4 shadow-xl backdrop-blur-sm sm:flex sm:flex-1 sm:items-center sm:justify-between sm:gap-6">
